...
const Home = () => {
  return (
    <div className={styles['container']}>
      <Helmet>
        <title>JOYCHEAT</title>
        <meta property="og:title" content="JOYCHEAT" />
      </Helmet>
      <div className={styles['Hero']}>
        ...
        <img
          alt="image"
          src="https://cdn.bitrix24.com/b18821159/landing/a78/a787232065091f049edebcfa0b57c4fa/photo_2022-01-01_23-28-07_1x.jpg"
        ...
        <div className={styles['container01']}>
          ...
          <div className={styles['WorkWithUs']}>
            <div className={styles['container06']}>
              ...
              <h3
                className={` ${styles['text12']} ${projectStyles['healine']} `}
              >
              ...
              <span className={styles['text18']}>Check Notus PRO React!</span>
            </div>
            <div className={styles['container08']}>
              ...
              <div className={styles['container10']}>
                ...
                >
                  <span className={styles['text20']}>Top Notch Services</span>
                  <br></br>
                </h4>
      ...
      <div className={styles['Section2']}>
        <div className={styles['container11']}>
          ...
          <h2 className={` ${styles['text23']} ${projectStyles['text2XL']} `}>
            <span className={styles['text24']}>
              You need to fight like David with Goliath
            </span>
            <br></br>
          </h2>
          <span className={` ${styles['text25']} ${projectStyles['textXL']} `}>
        ...
        <div className={styles['GrowingCompanySection']}>
          ...
          <div className={styles['container12']}>
            ...
            <h3 className={` ${styles['text26']} ${projectStyles['healine']} `}>
              A growing company
            </h3>
            ...
            <div className={styles['container16']}>
              ...
              <span className={styles['text29']}>Amazing page examples</span>
            </div>
            <div className={styles['container18']}>
              ...
              <span className={styles['text30']}>Dynamic components</span>
            </div>
          </div>
        </div>
        <div className={styles['container20']}>
          <h6 className={styles['text31']}>
            <span>THE ENTOURAGE</span>
          </h6>
          <h3 className={` ${styles['text33']} ${projectStyles['healine']} `}>
            It is everything, and it won&apos;t change
          </h3>
          <span className={` ${styles['text34']} ${projectStyles['textXL']} `}>
          ...
          <div className={styles['container21']}>
            <Link to="/profile" className={styles['navlink']}>
              <div className={styles['container22']}>
                <MemberDetails image_src="/playground_assets/team1-1500h.jpg"></MemberDetails>
            ...
            <Link to="/profile" className={styles['navlink1']}>
              <div className={styles['container27']}>
                <MemberDetails
                  ...
                  image_src="/playground_assets/team2-1500h.jpg"
                ></MemberDetails>
      ...
      <div className={styles['Section3']}>
        <div className={styles['container42']}>
          <h6 className={` ${styles['text36']} ${projectStyles['textSM']} `}>
            <span>ON THE COASTLINE</span>
          </h6>
          <h3 className={` ${styles['text38']} ${projectStyles['healine']} `}>
            We are missing the summer
          </h3>
          <span className={` ${styles['text39']} ${projectStyles['textXL']} `}>
          ...
          <div className={styles['Services']}>
            ...
            <div className={styles['container43']}>
              ...
              <h1
                className={` ${styles['text41']} ${projectStyles['textXL']} `}
              >
                Grow your market
              </h1>
            ...
            <div className={styles['container45']}>
              ...
              <h1
                className={` ${styles['text43']} ${projectStyles['textXL']} `}
              >
                Launch time
              </h1>
          ...
          <div className={styles['Contact']}>
            ...
            <h2 className={styles['text45']}>Type in the bellow form</h2>
            <span
              className={` ${styles['text46']} ${projectStyles['textXL']} `}
            >
            ...
            <div className={styles['Form']}>
              <h1 className={styles['text47']}>Want to work with us?</h1>
              <span
                className={` ${styles['text48']} ${projectStyles['textXL']} `}
              >
                Complete this form and we will get back to you in 24 hours.
              </span>
              <span
                className={` ${styles['text49']} ${projectStyles['textXS']} `}
              >
                FULL NAME
              </span>
              <input
              ...
              />
              <span
                className={` ${styles['text50']} ${projectStyles['textXS']} `}
              >
                EMAIL
              </span>
              <input
              ...
              />
              <span
                className={` ${styles['text51']} ${projectStyles['textXS']} `}
              >
                MESSAGE
              </span>
              <textarea
